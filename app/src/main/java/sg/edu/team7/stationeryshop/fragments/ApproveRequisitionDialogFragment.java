...
public class ApproveRequisitionDialogFragment extends DialogFragment {

    public ApproveRequisitionDialogFragment() {
        // Empty constructor is required for DialogFragment
        // Make sure not to add arguments to the constructor
        // Use `newInstance` instead as shown below
    }

    public static ApproveRequisitionDialogFragment newInstance(String title) {
        ApproveRequisitionDialogFragment frag = new ApproveRequisitionDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_approve_requisition_dialog, container);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        String title = getArguments().getString("title", "Enter Approval Remarks");
        ...
        // Initialize FAB
        FloatingActionButton approveButton = view.findViewById(R.id.approve_fab);
